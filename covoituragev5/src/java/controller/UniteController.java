...
public class UniteController implements Serializable {
    ...
    @EJB
    private service.UniteFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Bundle").getString("UniteCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Bundle").getString("UniteUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Bundle").getString("UniteDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    public Unite getUnite(java.lang.Long id) {
